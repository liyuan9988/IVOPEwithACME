...
class TerminatePredictor(snt.Module):
    ...
    def __init__(self, environment_spec, layer_sizes: Sequence[int]):
        ...
        self._net = snt.Sequential([
            ...
            snt.nets.MLP(layer_sizes + [1], activate_final=False),
            tf.sigmoid])
...
def make_value_func_bsuite(environment_spec,
                           ...
                           instrumental_layer_sizes: str = '150,100,50',
                           terminate_layer_sizes: str = '150,100,50',
    ...
    layer_sizes = list(map(int, terminate_layer_sizes.split(',')))
